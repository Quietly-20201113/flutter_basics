...
import 'package:flutterbasics/common/widget/custom_calendar/widget/month_view_pager.dart';
import 'package:flutterbasics/common/widget/custom_calendar/widget/week_view_pager.dart';
...
class CalendarContainerState extends State<CalendarContainer>
  ...
  void initState() {
    ...
    if (calendarProvider.calendarConfiguration.showMode ==
      ...
      widgets.add( MonthViewPager(calendarController: widget.calendarController, ));
      widgets.add(const WeekViewPager());
      index = 1;
    } else if (calendarProvider.calendarConfiguration.showMode ==
    ...
    widget.calendarController.addMonthChangeListener((year, month) {
      calendarProvider.lastMont = DateTime(year,month);
