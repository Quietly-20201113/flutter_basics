...
import 'package:flutterbasics/common/widget/custom_calendar/widget/default_combine_day_view.dart';
import 'package:flutterbasics/common/widget/custom_calendar/widget/default_custom_day_view.dart';
import 'package:flutterbasics/common/widget/custom_calendar/widget/default_week_bar.dart';
...
class CalendarController {
  ...
  CalendarController(
    ...
    calendarProvider.lastMont = new DateTime.now();
    calendarProvider.selectDateModel = selectDateModel;
    calendarProvider.isExceedNotClick = isExceedNotClick;
    ...
    print("start:${DateModel.fromDateTime(DateTime(
      minYear,
      minYearMonth,
